...
namespace ZForge.Win32
{
	...
	/// </summary>
	internal class RemovableDetectorForm : Form
	{
		private Label label1;
		private RemovableDriveDetector mDetector = null;
	...
	public delegate void RemovableDriveDetectorEventHandler(Object sender, RemovableDriveDetectorEventArgs e);

	/// <summary>
	/// Our class for passing in custom arguments to our event handlers 
	/// 
	/// </summary>
	public class RemovableDriveDetectorEventArgs : EventArgs
	{
		public RemovableDriveDetectorEventArgs()
		{
			Cancel = false;
			Drive = "";
	...
	/// </summary>
	public class RemovableDriveDetector : IDisposable
	{
		/// <summary>
		/// Events signalized to the client app.
		/// Add handlers for these events in your form to be notified of removable device events 
		/// </summary>
		public event RemovableDriveDetectorEventHandler DeviceArrived;
		public event RemovableDriveDetectorEventHandler DeviceRemoved;
		public event RemovableDriveDetectorEventHandler DeviceQueryRemove;
		public event RemovableDriveDetectorEventHandler DeviceChanged;
		...
		public RemovableDriveDetector(Control control)
		{
			Init(control, null);
		}
		...
		public RemovableDriveDetector(Control control, string FileToOpen)
		{
				...
				if (m.Msg == WM_DEVICECHANGE)
				{
					...
					switch (m.WParam.ToInt32())
					{
						case DBT_DEVNODES_CHANGED:
							RemovableDriveDetectorEventHandler tempDeviceChanged = DeviceChanged;
							if (tempDeviceChanged != null)
							{
								RemovableDriveDetectorEventArgs e = new RemovableDriveDetectorEventArgs();
						...
						case DBT_DEVICEARRIVAL:
							...
							if (devType == DBT_DEVTYP_VOLUME)
							{
								...
								RemovableDriveDetectorEventHandler tempDeviceArrived = DeviceArrived;
						...
						case DBT_DEVICEQUERYREMOVE:
							...
							if (devType == DBT_DEVTYP_HANDLE)
							{
								...
								//
								RemovableDriveDetectorEventHandler tempQuery = DeviceQueryRemove;
								if (tempQuery != null)
								{
									RemovableDriveDetectorEventArgs e = new RemovableDriveDetectorEventArgs();
						...
						case DBT_DEVICEREMOVECOMPLETE:
							...
							if (devType == DBT_DEVTYP_VOLUME)
							{
								...
								if (devType == DBT_DEVTYP_VOLUME)
								{
									...
									// Call the client event handler
									//
									RemovableDriveDetectorEventHandler tempDeviceRemoved = DeviceRemoved;
