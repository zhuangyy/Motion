...
namespace ZForge.Controls.Wizard
{
	/// <summary>
	...
	/// are of the wizard.
	/// </summary>
	[Designer(typeof(ZForge.Controls.Wizard.WizardDesigner))]
	[ToolboxItem(true)]
	[ToolboxBitmap(typeof(ZForge.Controls.Wizard.Wizard))]
	public class Wizard : System.Windows.Forms.UserControl
	{
		...
		private string btnFinishLabel = "Fi&nish";
		private string btnNextLabel = "&Next >";
		...
		private void InitializeComponent()
		{
			...
			this.pnlButtons.Location = new System.Drawing.Point(0, 217);
			this.pnlButtons.Name = "pnlButtons";
			this.pnlButtons.Size = new System.Drawing.Size(444, 55);
			...
			this.btnNext.Location = new System.Drawing.Point(272, 8);
			...
			this.btnBack.Location = new System.Drawing.Point(191, 8);
		...
		protected internal bool IsCurrentPageTheFinishPage()
		{
			return (this.PageIndex >= vPages.Count - 1 || vActivePage.IsFinishPage == true);
		}
		...
		/// <summary>
		/// Gets/Sets the finish button text. 
		/// </summary>
		[Category("Wizard")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public string FinishLabel
		{
			get
			{
				return this.btnFinishLabel;
			}
			set
			{
				btnFinishLabel = value;
				if (this.IsCurrentPageTheFinishPage())
				{
					btnNext.Text = btnFinishLabel;
				}
			}
		...
		/// <summary>
		/// Gets/Sets the Next button text. 
		/// </summary>
		[Category("Wizard")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		/// <summary>
		/// Gets/Sets the Back button text. 
		/// </summary>
		[Category("Wizard")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public string BackLabel
		{
			get
			{
				return this.btnBack.Text;
			}
			set
			{
				this.btnBack.Text = value;
			}
		}

		/// <summary>
		/// Gets/Sets the Cacnel button text. 
		/// </summary>
		[Category("Wizard")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
