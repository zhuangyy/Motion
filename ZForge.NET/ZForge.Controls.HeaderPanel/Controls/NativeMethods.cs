...
namespace ZForge.Controls
{
	...
	internal sealed class HeaderPanelNativeMethods
	{
		private HeaderPanelNativeMethods()
		{ }
		...
		public class TRACKMOUSEEVENT
		{
			...
			{
				this.cbSize = Marshal.SizeOf(typeof(HeaderPanelNativeMethods.TRACKMOUSEEVENT));
