namespace ZForge.Controls.PropertyGridEx
{
	...
	public partial class PropertyGridEx : PropertyGrid
	{
		...
		[Category("Appearance"), DisplayName("HelpHeight"), DescriptionAttribute("Help Height.")]
		public int DocCommentHeight
		{
			set
			{
				Control c = this.DocComment;
				Type controlType = c.GetType();
				PropertyInfo linesProperty = controlType.GetProperty("Height");
				linesProperty.SetValue(c, value, null);
				FieldInfo userSizedField = controlType.BaseType.GetField("userSized", BindingFlags.Instance | BindingFlags.NonPublic);
