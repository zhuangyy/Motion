namespace ZForge.Controls.PropertyGridEx
{
	...
	public class CustomProperty
	{
		...
		// Filepath editor properties
		protected bool bUseFilePathEditor = false;
		...
		[Category("Behavior"), DescriptionAttribute("Indicates if the property uses a FilePathEditor converter."), XmlElementAttribute(IsNullable = false)]
		public bool UseFilePathEditor
		{
			get
			{
				return bUseFilePathEditor;
			}
			set
			{
				bUseFilePathEditor = value;
			}
		}
