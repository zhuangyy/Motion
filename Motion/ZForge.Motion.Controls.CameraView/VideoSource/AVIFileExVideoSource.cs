...
namespace ZForge.Motion.VideoSource
{
	...
	/// </remarks>
	/// 
	public class AVIFileExVideoSource : IVideoSource
	{
		// video file name
		...
		// frame feed speed. 0 = pause, 1 = 1x, -2 = 1/2x and so on
		private int speed = 1;
		// pause
		...
		/// set to 100, then the d篼ired frame rate will be 10 frames per second. Default value is 0 -
		...
		public int Position
		{
			get { return this.aviReader.Position; }
			set { this.aviReader.Position = value; }
		}
		/// <summary>
		...
		~AVIFileExVideoSource()
		{
			this.aviReader.Dispose();
			this.aviReader = null;
		}
